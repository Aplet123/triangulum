...
svg.append("text").classed("title", true).html("TRIANGULUM").attr("width", "60%").attr("height", "20%").attr("x", "20%").attr("y", "0").attr("text-anchor", "middle").attr("alignment-baseline", "central");
var vp = svg.append("g");
for (var i = 0; i < 200; i ++) {
